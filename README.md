...
`setup-checklist.pdf` is generated by [`scripts/make-setup-checklist.py`](scripts/make-setup-checklist.py). If you
change the setup steps above, update the checklist items in that script to match and regenerate it with
`pip install reportlab` then `python3 scripts/make-setup-checklist.py`.
